<template>
  <f7-page>
    <f7-navbar title="Daftar Agent" back-link="Back"></f7-navbar>
    <f7-list form>
      <f7-list-item>
        ...
        <f7-input 
          ...
          name="username"
          :error-message="messageusername"
          :error-message-force="validateusername"
          :value="username"
    ...
    <f7-block strong>
      <f7-row tag="p">
        ...
        <f7-button class="col" big fill raised color="green" @click="processRegister">Submit</f7-button>
      </f7-row>
    </f7-block>
  </f7-page>
</template>
...
export default {
  data() {
    return {
      ...
      messageusername: 'Username 3-20 (angka dan huruf)',
